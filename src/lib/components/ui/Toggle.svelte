...
<label class="flex cursor-pointer items-start justify-between gap-4 py-2">
	...
	<Switch.Root
		...
		class="bg-base-300 data-[state=checked]:bg-primary peer relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full transition-colors disabled:cursor-not-allowed disabled:opacity-50"
	>
		<Switch.Thumb
			class="bg-base-100 pointer-events-none block h-5 w-5 translate-x-0.5 rounded-full shadow ring-0 transition-transform data-[state=checked]:translate-x-[1.375rem]"
		/>
	</Switch.Root>
</label>
